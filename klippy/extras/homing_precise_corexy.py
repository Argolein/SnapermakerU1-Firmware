        ...
        for revcount in range(len(point_sequence) // 2):
            ...
            for i in range(len(point_sequence)):
                ...
                if data['revalidate']:
                    ...
                    if probe_success == True:
                        ...
                        error = '{"coded": "0003-0528-0000-0024", "msg":"%s", "action": "cancel"}' % ("Home origin calibration failed, Corexy precise homing failed")
                        raise self.printer.command_error(error)
            ...
            for i in range(len(point_sequence)):
                ...
                if c_diff[0] != 0 or c_diff[1] != 0:
                    ...
                    error = '{"coded": "0003-0528-0000-0025", "msg":"%s", "action": "cancel"}' % (error_msg)
                    raise self.printer.command_error(error)
            ...
            if new_rev_cnt > rev_cnt:
                ...
                error = '{"coded": "0003-0528-0000-0026", "msg":"%s", "action": "cancel"}' % (error_msg)
                raise self.printer.command_error(error)
            ...
            if probe_success == True:
                ...
                if self.is_point_unstable([c_dist_a, c_dist_b], self.calibrated_origin):
                    ...
                    if home_unstable and not self.enable_home_validation:
                        error = '{"coded": "0003-0528-0000-0027", "msg":"%s", "action": "cancel"}' % ("Corexy home is unstable")
                        raise self.printer.command_error(error)
                    else:
                ...
                if self.enable_home_validation:
                    ...
                    if probe_success == True:
                        ...
                        if v_p_ab[0] - p_ab[0] != a_phase_offset or v_p_ab[1] - p_ab[1] != b_phase_offset:
                            error = '{"coded": "0003-0528-0000-0028", "msg":"%s", "action": "cancel"}' % ("Corexy validation point is invalid")
                            raise self.printer.command_error(error)
                    else:
